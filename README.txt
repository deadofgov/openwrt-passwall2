Необходимо заточить сугубо под NanoPI R2S, строго и обязательно пользуйся:
Version: SNAPSHOT
kernel-6.12.48~4266bd01be6159c4b72cb3dbb3476bfc-r1
https://downloads.openwrt.org/snapshots/targets/rockchip/armv8/openwrt-sdk-rockchip-armv8_gcc-14.3.0_musl.Linux-x86_64.tar.zst
